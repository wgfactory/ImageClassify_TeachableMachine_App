...
import com.wgf.classification.tm.env.BorderedText;
import com.wgf.classification.tm.env.Logger;
import com.wgf.classification.tm.tflite.Classifier;
import com.wgf.classification.tm.tflite.Classifier.Device;
import com.wgf.classification.tm.tflite.Classifier.Model;
...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  protected void onInferenceConfigurationChanged() {
    if (rgbFrameBitmap == null) {
      // Defer creation until we're getting camera_switch frames.
      return;
    }
